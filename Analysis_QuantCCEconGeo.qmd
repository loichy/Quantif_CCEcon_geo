...
df_final_merged <- df_final_merged %>%
 ...
 mutate(Total_trade=as.numeric(Total_trade))%>% 
 mutate(Comparative_advantage=as.numeric(Comparative_advantage))%>% 
 mutate(Trade_balance=as.numeric(Trade_balance))
...
selected_data <- df_final_merged[,c("N_CC","N_ratio","PIBValues","RDValues","EducFValues","EducHValues","CO2emissionsalues","NDC_Implied_average","NDC_Implied_conditional","NDC_Implied_unconditional","is_carbon_tax","ExpendituresValues","DisastersValues","TemperatureValues","Total_trade")]
...
df_final_merged <- df_final_merged %>%
  mutate(PY = as.factor(PY),    # Effet fixe année
         ...
         CO2_mega=CO2emissionsalues/1000)  # Effet fixe journal
```
...
stargazer(model1, 
          type = "text",
          keep=c("PIB_billion","RDValues","EducFValues","EducHValues","CO2emissionsalues","NDC_Implied_average", "is_carbon_tax","ExpendituresValues","DisastersValues","TemperatureValues","Comparative_advantage"))
```
...
```{r}
model2<- lm(N_CC ~ country + PIB_billion + RDValues + EducFValues + EducHValues + CO2emissionsalues + NDC_Implied_average + is_carbon_tax + ExpendituresValues + DisastersValues + TemperatureValues + Comparative_advantage, data = df_final_merged) 
...
Le niveu de développement n'est plus significtif, ce qui joue maintenant sont les dépenses en recherche et développement
...
```{r}
model3<- lm(N_CC ~ country + PY + PIB_billion + RDValues + EducFValues + EducHValues + CO2_mega + NDC_Implied_average + is_carbon_tax + ExpendituresValues + DisastersValues + TemperatureValues + Comparative_advantage, data = df_final_merged) 

stargazer(model3, 
          type = "text",
          keep=c("PIB_billion","RDValues","EducFValues","EducHValues","CO2_mega","NDC_Implied_average", "is_carbon_tax","ExpendituresValues","DisastersValues","TemperatureValues","Comparative_advantage"))
```
...
```{r}
model5<- lm(N_CC ~ country + PY + CO2emissionsalues + NDC_Implied_average + is_carbon_tax + ExpendituresValues + DisastersValues + TemperatureValues + Comparative_advantage, data = df_final_merged) 
stargazer(model5, 
          type = "text")
```
...
```{r}
model1<- lm(N_ratio ~ PIB_billion + RDValues + EducFValues + EducHValues + CO2emissionsalues + NDC_Implied_average + is_carbon_tax + ExpendituresValues + DisastersValues + TemperatureValues + Comparative_advantage, data = df_final_merged) # modèle sans effet fixe
vif(mod=model1)
stargazer(model1, 
          type = "text",
          keep=c("PIB_billion","RDValues","EducFValues","EducHValues","CO2emissionsalues","NDC_Implied_average", "is_carbon_tax","ExpendituresValues","DisastersValues","TemperatureValues","Comparative_advantage"))
...
```{r}
model2<- lm(N_ratio ~ country + PIB_billion + RDValues + EducFValues + EducHValues + CO2emissionsalues + NDC_Implied_average + is_carbon_tax + ExpendituresValues + DisastersValues + TemperatureValues + Comparative_advantage, data = df_final_merged) 
...
```{r}
model3<- lm(N_ratio ~ country + PY + PIBValues + RDValues + EducFValues + EducHValues + CO2emissionsalues + NDC_Implied_average + is_carbon_tax + ExpendituresValues + DisastersValues + TemperatureValues + Comparative_advantage, data = df_final_merged) 
...
```{r}
model5 <- lm(N_ratio ~ country + PY + CO2emissionsalues + NDC_Implied_average + is_carbon_tax + ExpendituresValues + DisastersValues + TemperatureValues + Comparative_advantage, data = df_final_merged) 
stargazer(model5, 
          type = "text")
```
